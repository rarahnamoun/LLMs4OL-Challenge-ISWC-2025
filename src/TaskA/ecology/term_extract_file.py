...
def print_random_docs_with_terms(documents_path, terms_path, sample_size=15):
    ...
    # Print info for each sampled document
    for doc in sample_docs:
        ...
        print("-" * 40)
print_random_docs_with_terms('documents.jsonl', 'terms2docs.json', sample_size=10)
...
print_random_docs_with_terms('documents.jsonl', 'terms2docs.json', sample_size=5)
